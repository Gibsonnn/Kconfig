...
hi xmlTag  ctermfg=197  ctermbg=NONE cterm=bold guifg=#F92672 guibg=NONE gui=bold
hi xmlTagName ctermfg=197 ctermbg=NONE cterm=bold guifg=#f92672 guibg=NONE gui=bold
hi xmlEndTag ctermfg=197  ctermbg=NONE cterm=bold guifg=#F92972 guibg=NONE gui=bold
" hi xmlEndTagName  ctermfg=255 ctermbg=NONE cterm=bold guifg=#F92672 guibg=#272822 gui=bold
"

" java synatax

hi javaScopeDecl ctermfg=197 ctermbg=NONE cterm=bold guifg=#f92672 guibg=NONE gui=bold 
hi javaMethodDecl ctermfg=197 ctermbg=NONE cterm=bold guifg=#f92672 guibg=NONE gui=bold 
hi javaClassDecl ctermfg=197 ctermbg=NONE cterm=bold guifg=#f92672 guibg=NONE gui=bold 
hi javaType ctermfg=81 gui=italic guifg=#66d9ef
hi javaTypedef ctermfg=81 gui=italic guifg=#66d9ef
hi javaConstant ctermfg=81 gui=italic guifg=#66d9ef
